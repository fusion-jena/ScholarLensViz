...
var my_sparql_query_CompRecSentence = [
                ...
                'SELECT DISTINCT ?competenceRecord ?content ?my_sent_start ?my_sent_end ?topic ?my_topic_start ?my_topic_end  WHERE{ ' +
                   '{ ' +
                    'SELECT ?sentence ?competence ?competenceRecord WHERE { ' +      
                        '{ ' +
...
exports.queryKnowledgeBase = function(researcher,uri){
